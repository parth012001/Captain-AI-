...
// 🆕 NEW: Import our refactored services
...
async function initializeServices() {
  ...
  // 🆕 NEW: Initialize refactored service container (parallel to existing)
  const serviceBootstrap = new ServiceBootstrap();
  await serviceBootstrap.initializeServices();
  console.log('✅ [REFACTOR] New service container initialized');
...
// 🆕 NEW: Refactored routes (running in parallel with existing routes for testing)
console.log('🔗 [REFACTOR] Registering new route endpoints...');
...
console.log('🔗 [PHASE 3] Registering infrastructure routes...');
...
console.log('✅ [PHASE 3] Infrastructure routes registered successfully');

console.log('✅ [REFACTOR] All new routes registered successfully');
...
// ====================================
// 🚀 REFACTORED ROUTES (V2 STRUCTURE)
// ====================================
    ...
    initializeServices().then(() => {
      app.listen(port, () => {
        ...
        if (env.NODE_ENV === 'development') {
          ...
          console.log('   🔐 Authentication: /auth/* (unchanged)');
          console.log('   📧 Emails: /api/v2/emails/*');
          console.log('   📝 Drafts: /api/v2/drafts/* & /api/v2/auto-drafts/*');
          console.log('   🤖 AI Analysis: /api/v2/ai/*');
          console.log('   📅 Calendar: /api/v2/calendar/*');
          console.log('   🤝 Meetings: /api/v2/meetings/*');
          console.log('   🎓 Learning: /api/v2/learning/*');
          console.log('   📡 Webhooks: /api/v2/webhooks/*');
          console.log('   🔧 Admin: /api/v2/admin/*');
          console.log('   🔍 Debug: /api/v2/debug/*');
          console.log('   ⚡ Misc: /api/v2/misc/*');
          console.log('\n📖 Migration Guide: /docs/API_MIGRATION_GUIDE.md');
          console.log('🎯 All legacy routes migrated to organized v2 structure!');
        }
      });
    })
    .catch((error) => {
